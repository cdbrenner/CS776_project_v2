...
Population::Population(Options& opt, int srand_offset)
{
    options = &opt;
...
void Population::evaluate(int choice, int** tsp_data, int random_seed, int srand_offset, int eval_option)
{
    for(int i = 0; i < options->population_size; i++)
    {
        try
...
void Population::evaluate_single(Individual& member, int choice, int** tsp_data, int random_seed, int srand_offset, int eval_option)
{
    for(int i = 0; i < options->population_size; i++)
    {
        try
...
void Population::genitor(int srand_offset, int eval_option)
{
    // TEST
